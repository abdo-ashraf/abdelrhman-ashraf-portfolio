...
const skills = [
  ...
  { name: 'PyTorch / TensorFlow', icon: Brain },
  { name: 'LLMs & LangChain', icon: Brain },
  { name: 'FastAPI / Streamlit', icon: Server },
  { name: 'AWS & Cloud', icon: Cloud },
  { name: 'SQL / NoSQL', icon: Database },
  { name: 'MLFlow / ZenML', icon: BarChart3 },
  { name: 'Docker / vLLM', icon: Server },
];
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <p className="text-lg text-muted-foreground leading-relaxed text-center">
            I'm a Data Scientist and Machine Learning Engineer passionate about designing 
            intelligent systems that solve real-world problems. I specialize in deep learning, 
            LLMs, AI agents, and building scalable end-to-end ML pipelines. I love solving 
            complex challenges, optimizing ML ecosystems, and continuously learning to push 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {skills.map((skill, index) => {
              ...
              return (
                <div
                  key={skill.name}
                  className="bg-card rounded-xl p-4 shadow-card hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1 group"
